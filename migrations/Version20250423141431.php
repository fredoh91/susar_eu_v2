 ...
 */
final class Version20250423141431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE substance_pt CHANGE codereactionmeddrapt codereactionmeddrapt INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE substance_pt CHANGE codereactionmeddrapt codereactionmeddrapt INT NOT NULL');
    }
}
