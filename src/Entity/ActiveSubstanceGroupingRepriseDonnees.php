...
use App\Repository\ActiveSubstanceGroupingRepriseDonneesRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: ActiveSubstanceGroupingRepriseDonneesRepository::class)]
class ActiveSubstanceGroupingRepriseDonnees
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
